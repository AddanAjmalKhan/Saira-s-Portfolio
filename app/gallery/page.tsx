  ...
  return (
    <main className="min-h-screen bg-night pt-32 pb-20 sm:pt-40">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        ...
        <p className="text-center text-ink-soft mb-16 max-w-2xl mx-auto">
          A visual journey through my international research, laboratory work, conferences, and field experiences.
        </p>
        
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {images.map((img, index) => (
            <div key={index} className="group relative overflow-hidden rounded-md bg-white aspect-square border border-forest-50 shadow-sm hover:shadow-md transition-shadow">
