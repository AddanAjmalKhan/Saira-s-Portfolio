...
export default function CollaborationsPage() {
  const currentProjects = [
    {
      title: "MSCA Natural Traces",
      partner: "National University of San Juan, Argentina",
      description: "Air Forensics project combining human and non-human environmental DNA."
    },
    {
      title: "Genomic Insights into Diaporthe amygdali",
      partner: "University of Tuscia, Italy",
      description: "Investigating genomic features and molecular mechanisms underlying pathogenicity on peach trees."
    }
  ];
  ...
  return (
    <main className="min-h-screen bg-night pt-32 pb-20 sm:pt-40">
      <div className="mx-auto max-w-5xl px-4 sm:px-6">
        <h1 className="mb-6 font-display text-4xl font-bold tracking-tight text-forest-900 sm:text-5xl">
          Research <span className="text-mint">Collaborations</span>
        </h1>
        <p className="mb-16 text-lg text-ink-soft max-w-3xl">
        ...
        <div className="grid gap-12 md:grid-cols-2">
          <div>
            <h2 className="mb-8 text-2xl font-bold text-forest-900 flex items-center gap-3">
            ...
            <div className="space-y-6">
              {currentProjects.map((project, index) => (
                <div key={index} className="rounded-md border border-forest-50 bg-white p-6 shadow-sm">
                  <h3 className="mb-2 text-xl font-semibold text-mint">{project.title}</h3>
                  <p className="mb-3 text-sm font-medium text-forest-900">{project.partner}</p>
          ...
          <div className="rounded-md border border-mint/20 bg-white p-8 flex flex-col items-center justify-center text-center shadow-sm">
            ...
            <h2 className="mb-4 text-2xl font-bold text-forest-900">Open for Collaboration</h2>
