        ...
        <div className="grid gap-6 md:grid-cols-2">
          {trainings.map((training, index) => (
            <Reveal key={index} delay={index * 100} from="up" as="div" className="h-full">
              <div className="h-full flex flex-col justify-between bg-white p-8 rounded-2xl shadow-sm border border-slate-200 hover:shadow-xl hover:border-mint/30 transition-all duration-300 group">
                <div>
