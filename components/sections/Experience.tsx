...
export default function Experience() {
  return (
    <section id="experience" className="scroll-mt-24 bg-cream pb-24 sm:pb-28">
      <Container>
        <Reveal className="relative overflow-hidden rounded-[2.5rem] bg-gradient-to-br from-amber-deep via-[#a9712f] to-forest-700 p-8 text-cream shadow-[0_30px_70px_-40px_rgba(33,31,23,0.6)] sm:p-12">
          <div className="bg-dot-grid-dark absolute inset-0 opacity-50" aria-hidden />
          <Sparkle
            size={40}
            animate
            className="absolute right-8 top-8 text-cream/40"
          />

          <div className="relative max-w-2xl">
            <span className="font-mono text-xs font-semibold uppercase tracking-ultra text-cream/70">
              03 — Experience
            </span>
